...
var Changelog = []Entry{
	{
		...
		Changes: []string{
			...
			"New Device diagnostics: an admin defines a set of read-only property checks in Settings (for example Build ID, Model, Android version, Battery, Storage), and testers, devs and admins can run them from any device page with one tap to see the result — no shell access required.",
