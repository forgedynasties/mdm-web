...
CREATE TABLE IF NOT EXISTS users (
    ...
    role          TEXT NOT NULL CHECK (role IN ('viewer','operator','tester','user_manager','dev','admin','owner')),
    created_at    TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
ALTER TABLE users ADD  CONSTRAINT users_role_check CHECK (role IN ('viewer','operator','tester','user_manager','dev','admin','owner'));
