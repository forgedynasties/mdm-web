...
func TestHealthScoreIsProportionate(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			wantAtLeast: 0, wantAtMost: 25, wantClass: "danger",
		},
		{
...
func TestHealthScoreSeparatesDormantFromOffline(t *testing.T) {
	...
	if dormant.Score < 90 {
		t.Errorf("dormant-only venue scored %d; the nudge is capped at -6", dormant.Score)
	}
